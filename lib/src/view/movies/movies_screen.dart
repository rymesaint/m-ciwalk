...
import 'package:ciwalk/src/view_models/movie.vm.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:velocity_x/velocity_x.dart';

class MoviesScreen extends GetView<MovieViewModel> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: 'Ongoing Movies'.text.make(),
        actions: [
          // IconButton(
                    ...
                    child: Builder(
                      builder: (context) => GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final movie = controller.result.value.data![index];
                            return MovieCard(
                              movie: movie,
                              onTap: () => controller.openDetail(movie),
                            );
                          }),
                    ),
